...
const Navbar = ( ) => {
  ...
  const [sideBar, setSideBar] = useState('-left-96')
        ...
        <div className={`Navbar   backdrop-blur-lg mx-auto flex items-center justify-between rounded-lg  bg-white/20 md:w-[92vw] h-20 md:mt-4`}>
            ...
            <div className="center">
                ...
                <Link href="/">    <li className='cursor-pointer hidden md:block hover:underline transition duration-400'>Home</li></Link>
                    ...
                    <li className='cursor-pointer hidden md:block hover:underline transition duration-400'>Plans and Pricing</li>


                 <Link href="/About"><li className='cursor-pointer hidden md:block hover:underline transition duration-400'>About me</li></Link>   


                    <li className='cursor-pointer hidden md:block hover:underline transition duration-400'>Road map</li>
...
<ul className=' my-14 ml-10 font-bold text-white'>

   <Link href="/"> <li className='cursor-pointer mt-3 flex items-center gap-2   hover:underline transition duration-400'>
    ...
    <li className='cursor-pointer mt-3 flex items-center gap-2   hover:underline transition duration-400'>
        ...
        Plans and Pricing</li>


  <Link href="/About"> <li className='cursor-pointer mt-3 flex items-center gap-2  hover:underline transition duration-400'>
